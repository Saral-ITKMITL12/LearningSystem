        ...
        <div class="col-md-10 col-md-offset-1">
          ...
          <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            <ul class="nav nav-tabs" id="myTabs" role="tablist">
              ...
              <li role="presentation" class="custom-search-input">
                <form class="form-inline" action="index.html" method="post">
                  <input type="text" class="form-control input-md" placeholder="Search" id="searchID" data-loading-text="Searching..."/>

                  <button class="btn btn-info btn-md" type="button" id="searchBtn">
            ...
            <div class="tab-content" id="myTabContent">
              @include('admins.list.userTableAndPagination')
            </div>
            </div>
          </div>
        </div>
